...
%mdl = fitcknn(X', Y);
load 'ocrsegments';
mdl = ocr_train(S,y,20);
save('classification_data', 'mdl');


%% Setup the names of the functions of your OCR system.
mysystem.segmenter = 'im2segment_2'; % What is the name of your segmentation-algorithm.
mysystem.features = 'segment2features_2'; % What is the name of your features-algorithm.
mysystem.classifier = 'features2class'; % What is the name of your classification-algorithm.
load classification_data;
mysystem.classification_data = mdl;
